...
- Current public feed cards should show place/date, title, a maximum two-line description with inline "See more" only when truncated, and then the photo block. Any attached photos should render as a full-width social-feed image block.
